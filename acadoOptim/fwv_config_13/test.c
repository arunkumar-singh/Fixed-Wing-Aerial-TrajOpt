...
int main( )
{
	...
	init_goal(XG, YG, ZG);			           
	//init_weights(1.0, 1.0, 1.0, 1000.0, 1000.0, 1000.0, 100.0, 100.0, 100.0); // x y z x[-1] y[-1] z[-1] a phidot gammadot
	init_weights(1.0, 1.0, 1.0, 1000.0, 1000.0, 1000.0, 100.0, 10000.0, 10000.0);
	for (i = 0; i < (N + 1); ++i)  
	{
	...
	for (i = 0; i <  N; ++i) 
	{	
		acadoVariables.u[ i*NU + 0 ] = 0.0000;
		acadoVariables.u[ i*NU + 1 ] = 0.0000;
		acadoVariables.u[ i*NU + 2 ] = 0.0000;
	}	
	plant_model();
